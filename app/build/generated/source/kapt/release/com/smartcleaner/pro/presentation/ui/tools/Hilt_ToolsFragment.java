 ...
 */
public abstract class Hilt_ToolsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ToolsFragment_GeneratedInjector) this.generatedComponent()).injectToolsFragment(UnsafeCasts.<ToolsFragment>unsafeCast(this));
    }
  }
