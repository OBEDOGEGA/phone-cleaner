 ...
 */
public abstract class Hilt_BatteryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BatteryFragment() {
    super();
  }

  Hilt_BatteryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BatteryFragment_GeneratedInjector) this.generatedComponent()).injectBatteryFragment(UnsafeCasts.<BatteryFragment>unsafeCast(this));
    }
  }
