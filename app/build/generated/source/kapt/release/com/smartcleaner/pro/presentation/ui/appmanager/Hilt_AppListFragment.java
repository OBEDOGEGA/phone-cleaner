 ...
 */
public abstract class Hilt_AppListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppListFragment_GeneratedInjector) this.generatedComponent()).injectAppListFragment(UnsafeCasts.<AppListFragment>unsafeCast(this));
    }
  }
