    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoCleaningHistory.equals(_existingCleaningHistory)) {
          return new RoomOpenHelper.ValidationResult(false, "cleaning_history(com.smartphonecleaner.pro.data.local.CleaningHistory).\n"
        ...
        if (!_infoWhitelistedApps.equals(_existingWhitelistedApps)) {
          return new RoomOpenHelper.ValidationResult(false, "whitelisted_apps(com.smartphonecleaner.pro.data.local.WhitelistedApp).\n"
        ...
        if (!_infoUserPreferences.equals(_existingUserPreferences)) {
          return new RoomOpenHelper.ValidationResult(false, "user_preferences(com.smartphonecleaner.pro.data.local.UserPreference).\n"
        ...
        if (!_infoAdImpressions.equals(_existingAdImpressions)) {
          return new RoomOpenHelper.ValidationResult(false, "ad_impressions(com.smartphonecleaner.pro.data.local.AdImpression).\n"
                  + " Expected:\n" + _infoAdImpressions + "\n"
