 ...
 */
public abstract class Hilt_MemoryBoosterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MemoryBoosterFragment() {
    super();
  }

  Hilt_MemoryBoosterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MemoryBoosterFragment_GeneratedInjector) this.generatedComponent()).injectMemoryBoosterFragment(UnsafeCasts.<MemoryBoosterFragment>unsafeCast(this));
    }
  }
