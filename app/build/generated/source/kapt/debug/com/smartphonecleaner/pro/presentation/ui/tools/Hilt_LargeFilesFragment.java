 ...
 */
public abstract class Hilt_LargeFilesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LargeFilesFragment_GeneratedInjector) this.generatedComponent()).injectLargeFilesFragment(UnsafeCasts.<LargeFilesFragment>unsafeCast(this));
    }
  }
