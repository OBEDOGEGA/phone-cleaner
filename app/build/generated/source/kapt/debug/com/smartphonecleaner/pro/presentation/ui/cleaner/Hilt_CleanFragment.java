 ...
 */
public abstract class Hilt_CleanFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CleanFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CleanFragment_GeneratedInjector) this.generatedComponent()).injectCleanFragment(UnsafeCasts.<CleanFragment>unsafeCast(this));
    }
  }
