 ...
 */
public abstract class Hilt_DuplicateFinderFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DuplicateFinderFragment_GeneratedInjector) this.generatedComponent()).injectDuplicateFinderFragment(UnsafeCasts.<DuplicateFinderFragment>unsafeCast(this));
    }
  }
