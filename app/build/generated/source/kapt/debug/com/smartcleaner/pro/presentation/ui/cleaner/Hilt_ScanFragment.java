 ...
 */
public abstract class Hilt_ScanFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ScanFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScanFragment_GeneratedInjector) this.generatedComponent()).injectScanFragment(UnsafeCasts.<ScanFragment>unsafeCast(this));
    }
  }
