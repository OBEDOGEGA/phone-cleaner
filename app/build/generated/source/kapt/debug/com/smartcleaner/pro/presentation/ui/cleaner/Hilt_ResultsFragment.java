 ...
 */
public abstract class Hilt_ResultsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResultsFragment() {
    super();
  }

  Hilt_ResultsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResultsFragment_GeneratedInjector) this.generatedComponent()).injectResultsFragment(UnsafeCasts.<ResultsFragment>unsafeCast(this));
    }
  }
