...
public final class NativeAdLayoutBinding implements ViewBinding {
  ...
  private NativeAdLayoutBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  public static NativeAdLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdLayoutBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
          adCallToAction, adHeadline, nativeAdView);
    }
